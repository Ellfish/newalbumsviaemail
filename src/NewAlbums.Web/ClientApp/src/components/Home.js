...
export class Home extends Component {
    ...
    render() {
        ...
        const scopes = encodeURIComponent('user-follow-read user-top-read user-read-email user-follow-modify user-library-read user-library-modify');
                ...
                <div className='how-does-it-work-container'>
                    <div className='how-does-it-work-step'>
                        <div className='image-container'>
                            <img src='/images/how-does-it-work-step-1.jpg' alt='Allow Spotify access' width='220' height='220' />
                    ...
                    <div className='how-does-it-work-step'>
                        <div className='image-container'>
                            <img src='/images/how-does-it-work-step-2.jpg' alt='Choose artists' width='220' height='220' />
                            <div className='center-hole' />
                        </div>
                    ...
                    <div className='how-does-it-work-step'>
                        <div className='image-container'>
                            <img src='/images/how-does-it-work-step-3.jpg' alt='Enter email address' width='220' height='220' />
                            <div className='center-hole' />
                        </div>
